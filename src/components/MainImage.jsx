...
const MainImage = ({deviceType}) => {
  ...
  useEffect(()=>{
    ...
    if(mainImageTextStatus){
      ...
      if(deviceType ==='window'){
        ...
        mainTextTimeLine.to('#mainImageTexts .char' , {
          opacity : 1,
          stagger : .05,
        })
      }
  ...
  return (
    <div id='mainImageContainer' className='flex flex-col gap-8 md:gap-0 md:items-start md:justify-between md:flex-row'>
        ...
        <div id='mainImageTexts' className='text-[#bfc9e8] text-6xl leading-none font-bold  font-mango main-image-text select-none md:text-8xl'>
